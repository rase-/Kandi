...
Toinen keino on vähentää tarkasteltujen mutanttien määrää. Tätä voidaan vähentää vain johonkin ennalta sovittuun määrään asti, tai keinoilla x.
% täsmennä x
...
% vois esitellä CBT ja sen sovellus

\subsection{Geneettisen algoritmin soveltaminen}
